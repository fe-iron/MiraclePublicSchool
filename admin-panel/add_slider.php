<?php
  ...
  if (isset($_POST['submit'])){
      ...
      $target_file1 = $target_dir . basename($_FILES["slider"]["name"]);
          // Select file type
      ...
      $extensions_arr = array("jpg","jpeg","png");
          ...
          if( in_array($imageFileType1,$extensions_arr) ){
              // Upload file
              if(move_uploaded_file($_FILES['slider']['tmp_name'],$target_dir.$photo)){
                 // Insert record
                 $query = "INSERT INTO sliders (slider) values('$photo')";
                  // echo $query;
  ...
  <section>
    ...
    <div class="sidebar">
      ...
      <div class="" id="sidebar-here">
        <a href="banner.php" class="list ">Banner</a>
      ...
      <div class="col-md-10">
        <div class="card my-5 shadow">
          <nav class="navbar navbar-light  venue-registration border-bottom">
            <a class="h4 text-dark font-weight-bold pt-2">Slider</a>
            <form class="form-inline">
              <a href="slider.php" class="btn btn-primary">View Slider</a>
            </form>
          </nav>
            ...
            <form  method="post" action=" " enctype="multipart/form-data">
              <div class="form-row pt-3">
                <div class="col-md mb-3">
                  <label for="Venue" class="font-weight-bold">Add Slider Photo*</label>
                  <input type="file" name="slider" class="form-control" placeholder="Upload Photo" id="venue-name" required>
                </div>
              </div>
