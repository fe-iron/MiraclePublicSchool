<?php
  ...
  if (isset($_POST['submit'])){
      ...
      $news = $_POST['news'];    
      // Insert record
      $query = "INSERT INTO news_and_update (event_date, news, is_event) values('$date', '$news', 1)";
      // echo $query;
      ...
      ?>
        ...
        <div class="card my-5 shadow">
          <nav class="navbar navbar-light  venue-registration border-bottom">
            <a class="h4 text-dark font-weight-bold pt-2">Add New Events</a>
            <form class="form-inline">
              <a href="event.php" class="btn btn-primary">View news List</a>
            </form>
          </nav>
            ...
            <form  method="post" action=" ">
              ...
              <div class="form-row">
                <div class="col-md">
                  ...
                  <input type="date" name="event_date" class="form-control" placeholder="Enter News Date" id="venue-name" required="required">
                </div>
              </div>
