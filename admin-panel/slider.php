<?php
  ...
  if (isset($_GET['id'])){
    ...
    $query = "DELETE FROM sliders WHERE id='$this_id'";
      ...
      <div class="col-md-11">
        <div class="card my-5 shadow">
          <nav class="navbar navbar-light  venue-registration border-bottom">
            <a class="h4 text-dark font-weight-bold pt-2">Slider List</a>
            <form class="form-inline">
              <a href="add_slider.php" class="btn-primary btn">Add New Slider</a>
            </form>
          </nav>
           <div class="card-body ">
           <h4 class="text-danger text-center">
            ...
            <div class="table-responsive">
              <table class="table table-bordered">
                <thead class="border">
                  <tr>
                    <th scope="col" class="border-right text-center">Sliders Images</th>  
                  </tr>
                </thead>
                <tbody> 
                <?php
                  while($data = mysqli_fetch_assoc($sliders))
                  {
                    ?><tr class="border-bottom">
                      <td class="border-right border-left text-center"> <img src="upload/slider/<?php echo $data['slider']; ?>" style="width: 220px; height: auto;"> </td>
                     
                      <td class="border-right text-center">
                        <div class="btn-group" role="group" aria-label="Basic example">
                          
                          <a href="slider.php?id=<?php echo $data['id'];?>" type="submit" class="btn btn-danger">
                            Delete
                          </a>
                        </div>
                      </td>
