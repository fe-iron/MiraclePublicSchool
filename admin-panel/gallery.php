<?php
  ...
  if (isset($_POST['submit'])){
      ...
      $photo = $_FILES['gallery']['name'];
      $target_file1 = $target_dir . basename($_FILES["gallery"]["name"]);
          // Select file type
      ...
      $extensions_arr = array("jpg","jpeg","png");
          ...
          if( in_array($imageFileType1,$extensions_arr) ){
              // Upload file
              if(move_uploaded_file($_FILES['gallery']['tmp_name'],$target_dir.$photo)){
                 // Insert record
                 $query = "INSERT INTO gallery (image) values('$photo')";
                  // echo $query;
      ...
      <div class="col-md-10">
        <div class="card my-5 shadow">
          <nav class="navbar navbar-light  venue-registration border-bottom">
            <a class="h4 text-dark font-weight-bold pt-2">Add Gallery Images</a>
            <form class="form-inline">
              <a href="gallery_image_list.php" class="btn btn-primary">View Gallery List</a>
            </form>
          </nav>
            ...
            <form  method="post" action=" " enctype="multipart/form-data">
              <div class="form-row pt-3">
                <div class="col-md mb-3">
                  <label for="Venue" class="font-weight-bold">Upload Image For Gallery*</label>
                  <input type="file" name="gallery" class="form-control" placeholder="Upload Image Here" required>
                </div>
              </div>
